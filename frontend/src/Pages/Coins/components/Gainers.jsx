...
const CoinCard = ({ data }) => {
    ...
    return (
        ...
        hover:bg-zinc-600/20 hover:border-green-400/50 transition-all ease-in-out duration-300'>
            ...
            <Box className='my-auto'>
                <Text className='text-xl text-green-500'> {data.PercentChange} </Text>
            </Box>
        </Box>
    )
}
...
const Coins = ({ Gainers }) => {
    return (
        ...
        2xl:h-[40vh] xl:h-[39.5vh] xl:w-[35vw] 2xl:w-[37.5vw] py-4 px-6'>
            <Text className='font-semibold text-3xl text-green-600'>Top Gainers (24 Hr) :</Text>
