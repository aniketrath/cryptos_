    ...
    return (
        ...
        hover:bg-zinc-600/20 hover:border-orange-300/50 transition-all ease-in-out duration-300'>
            <Box horizontal className='gap-4 my-auto'>
                ...
                <Text className='text-xl text-zinc-500'>Polygon</Text>
            </Box>
            <Box className='my-auto'>
                <Text className='text-xl text-zinc-500'>MATIC</Text>
            </Box>
        </Box>
    )
}
...
const Exchanges = () => {
    return (
        ...
        2xl:h-[48vh] xl:h-[41.5vh] xl:w-[35vw] 2xl:w-[37.5vw] py-4 px-6'>
            <Text className='font-semibold text-3xl'>Asset Platforms  :</Text>
            ...
            border-t border-b border-zinc-600'>
                <Box horizontal className='gap-2 h-10'>
                    <Text className='text-xl font-semibold my-auto'>Asset</Text>
                    <ArrowSwapVertical className='my-auto mx-2'
                        size="20"
                        color="#d9e3f0"
                    /> </Box>
                <Box horizontal className='gap-2 h-10'>
                    <Text className='text-xl font-semibold my-auto'>Native Curr.</Text>
                    <ArrowSwapVertical className='my-auto mx-2'
                        size="20"
                        color="#d9e3f0"
                    /> </Box>
